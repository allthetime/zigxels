...
pub const struct_c2r = extern struct {
    c: f32 = @import("std").mem.zeroes(f32),
    s: f32 = @import("std").mem.zeroes(f32),
};
pub const c2r = struct_c2r;
pub const struct_c2m = extern struct {
    x: c2v = @import("std").mem.zeroes(c2v),
    y: c2v = @import("std").mem.zeroes(c2v),
};
pub const c2m = struct_c2m;
pub const struct_c2x = extern struct {
    p: c2v = @import("std").mem.zeroes(c2v),
    r: c2r = @import("std").mem.zeroes(c2r),
};
pub const c2x = struct_c2x;
pub const struct_c2h = extern struct {
    n: c2v = @import("std").mem.zeroes(c2v),
    d: f32 = @import("std").mem.zeroes(f32),
};
pub const c2h = struct_c2h;
...
pub const struct_c2AABB = extern struct {
    min: c2v = @import("std").mem.zeroes(c2v),
    max: c2v = @import("std").mem.zeroes(c2v),
};
pub const c2AABB = struct_c2AABB;
pub const struct_c2Capsule = extern struct {
    a: c2v = @import("std").mem.zeroes(c2v),
    b: c2v = @import("std").mem.zeroes(c2v),
    r: f32 = @import("std").mem.zeroes(f32),
};
pub const c2Capsule = struct_c2Capsule;
pub const struct_c2Poly = extern struct {
    count: c_int = @import("std").mem.zeroes(c_int),
    verts: [8]c2v = @import("std").mem.zeroes([8]c2v),
    norms: [8]c2v = @import("std").mem.zeroes([8]c2v),
};
pub const c2Poly = struct_c2Poly;
pub const struct_c2Ray = extern struct {
    p: c2v = @import("std").mem.zeroes(c2v),
    d: c2v = @import("std").mem.zeroes(c2v),
    t: f32 = @import("std").mem.zeroes(f32),
};
pub const c2Ray = struct_c2Ray;
pub const struct_c2Raycast = extern struct {
    t: f32 = @import("std").mem.zeroes(f32),
    n: c2v = @import("std").mem.zeroes(c2v),
};
pub const c2Raycast = struct_c2Raycast;
pub const struct_c2Manifold = extern struct {
    count: c_int = @import("std").mem.zeroes(c_int),
    depths: [2]f32 = @import("std").mem.zeroes([2]f32),
    contact_points: [2]c2v = @import("std").mem.zeroes([2]c2v),
    n: c2v = @import("std").mem.zeroes(c2v),
};
pub const c2Manifold = struct_c2Manifold;
...
pub extern fn c2AABBtoAABB(A: c2AABB, B: c2AABB) c_int;
pub extern fn c2AABBtoCapsule(A: c2AABB, B: c2Capsule) c_int;
pub extern fn c2CapsuletoCapsule(A: c2Capsule, B: c2Capsule) c_int;
pub extern fn c2CircletoPoly(A: c2Circle, B: [*c]const c2Poly, bx: [*c]const c2x) c_int;
pub extern fn c2AABBtoPoly(A: c2AABB, B: [*c]const c2Poly, bx: [*c]const c2x) c_int;
pub extern fn c2CapsuletoPoly(A: c2Capsule, B: [*c]const c2Poly, bx: [*c]const c2x) c_int;
pub extern fn c2PolytoPoly(A: [*c]const c2Poly, ax: [*c]const c2x, B: [*c]const c2Poly, bx: [*c]const c2x) c_int;
pub extern fn c2RaytoCircle(A: c2Ray, B: c2Circle, out: [*c]c2Raycast) c_int;
pub extern fn c2RaytoAABB(A: c2Ray, B: c2AABB, out: [*c]c2Raycast) c_int;
pub extern fn c2RaytoCapsule(A: c2Ray, B: c2Capsule, out: [*c]c2Raycast) c_int;
pub extern fn c2RaytoPoly(A: c2Ray, B: [*c]const c2Poly, bx_ptr: [*c]const c2x, out: [*c]c2Raycast) c_int;
pub extern fn c2CircletoCircleManifold(A: c2Circle, B: c2Circle, m: [*c]c2Manifold) void;
pub extern fn c2CircletoAABBManifold(A: c2Circle, B: c2AABB, m: [*c]c2Manifold) void;
pub extern fn c2CircletoCapsuleManifold(A: c2Circle, B: c2Capsule, m: [*c]c2Manifold) void;
pub extern fn c2AABBtoAABBManifold(A: c2AABB, B: c2AABB, m: [*c]c2Manifold) void;
pub extern fn c2AABBtoCapsuleManifold(A: c2AABB, B: c2Capsule, m: [*c]c2Manifold) void;
pub extern fn c2CapsuletoCapsuleManifold(A: c2Capsule, B: c2Capsule, m: [*c]c2Manifold) void;
pub extern fn c2CircletoPolyManifold(A: c2Circle, B: [*c]const c2Poly, bx: [*c]const c2x, m: [*c]c2Manifold) void;
pub extern fn c2AABBtoPolyManifold(A: c2AABB, B: [*c]const c2Poly, bx: [*c]const c2x, m: [*c]c2Manifold) void;
pub extern fn c2CapsuletoPolyManifold(A: c2Capsule, B: [*c]const c2Poly, bx: [*c]const c2x, m: [*c]c2Manifold) void;
pub extern fn c2PolytoPolyManifold(A: [*c]const c2Poly, ax: [*c]const c2x, B: [*c]const c2Poly, bx: [*c]const c2x, m: [*c]c2Manifold) void;
pub const C2_TYPE_NONE: c_int = 0;
pub const C2_TYPE_CIRCLE: c_int = 1;
pub const C2_TYPE_AABB: c_int = 2;
pub const C2_TYPE_CAPSULE: c_int = 3;
pub const C2_TYPE_POLY: c_int = 4;
pub const C2_TYPE = c_uint;
pub const struct_c2GJKCache = extern struct {
    metric: f32 = @import("std").mem.zeroes(f32),
    count: c_int = @import("std").mem.zeroes(c_int),
    iA: [3]c_int = @import("std").mem.zeroes([3]c_int),
    iB: [3]c_int = @import("std").mem.zeroes([3]c_int),
    div: f32 = @import("std").mem.zeroes(f32),
};
pub const c2GJKCache = struct_c2GJKCache;
pub extern fn c2GJK(A: ?*const anyopaque, typeA: C2_TYPE, ax_ptr: [*c]const c2x, B: ?*const anyopaque, typeB: C2_TYPE, bx_ptr: [*c]const c2x, outA: [*c]c2v, outB: [*c]c2v, use_radius: c_int, iterations: [*c]c_int, cache: [*c]c2GJKCache) f32;
pub const struct_c2TOIResult = extern struct {
    hit: c_int = @import("std").mem.zeroes(c_int),
    toi: f32 = @import("std").mem.zeroes(f32),
    n: c2v = @import("std").mem.zeroes(c2v),
    p: c2v = @import("std").mem.zeroes(c2v),
    iterations: c_int = @import("std").mem.zeroes(c_int),
};
pub const c2TOIResult = struct_c2TOIResult;
pub extern fn c2TOI(A: ?*const anyopaque, typeA: C2_TYPE, ax_ptr: [*c]const c2x, vA: c2v, B: ?*const anyopaque, typeB: C2_TYPE, bx_ptr: [*c]const c2x, vB: c2v, use_radius: c_int) c2TOIResult;
pub extern fn c2Inflate(shape: ?*anyopaque, @"type": C2_TYPE, skin_factor: f32) void;
pub extern fn c2Hull(verts: [*c]c2v, count: c_int) c_int;
pub extern fn c2Norms(verts: [*c]c2v, norms: [*c]c2v, count: c_int) void;
pub extern fn c2MakePoly(p: [*c]c2Poly) void;
pub extern fn c2Collided(A: ?*const anyopaque, ax: [*c]const c2x, typeA: C2_TYPE, B: ?*const anyopaque, bx: [*c]const c2x, typeB: C2_TYPE) c_int;
pub extern fn c2Collide(A: ?*const anyopaque, ax: [*c]const c2x, typeA: C2_TYPE, B: ?*const anyopaque, bx: [*c]const c2x, typeB: C2_TYPE, m: [*c]c2Manifold) void;
pub extern fn c2CastRay(A: c2Ray, B: ?*const anyopaque, bx: [*c]const c2x, typeB: C2_TYPE, out: [*c]c2Raycast) c_int;
...
// /Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX26.2.sdk/usr/include/math.h:210:49: warning: TODO implement function '__builtin_inf' in std.zig.c_builtins

// /Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX26.2.sdk/usr/include/math.h:209:28: warning: unable to translate function, demoted to extern
pub extern fn __inline_isfinited(arg___x: f64) c_int;
// /Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX26.2.sdk/usr/include/math.h:213:26: warning: TODO implement function '__builtin_fabsl' in std.zig.c_builtins

// /Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX26.2.sdk/usr/include/math.h:212:28: warning: unable to translate function, demoted to extern
...
// /Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX26.2.sdk/usr/include/math.h:219:35: warning: TODO implement function '__builtin_inf' in std.zig.c_builtins

// /Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX26.2.sdk/usr/include/math.h:218:28: warning: unable to translate function, demoted to extern
pub extern fn __inline_isinfd(arg___x: f64) c_int;
// /Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX26.2.sdk/usr/include/math.h:222:12: warning: TODO implement function '__builtin_fabsl' in std.zig.c_builtins

// /Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX26.2.sdk/usr/include/math.h:221:28: warning: unable to translate function, demoted to extern
...
// /Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX26.2.sdk/usr/include/math.h:266:39: warning: TODO implement function '__builtin_fabsl' in std.zig.c_builtins

// /Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX26.2.sdk/usr/include/math.h:265:28: warning: unable to translate function, demoted to extern
...
pub inline fn c2Absv(arg_a: c2v) c2v {
    var a = arg_a;
    _ = &a;
    return c2V(if (a.x < @as(f32, @floatFromInt(@as(c_int, 0)))) -a.x else a.x, if (a.y < @as(f32, @floatFromInt(@as(c_int, 0)))) -a.y else a.y);
}
...
pub inline fn c2SafeNorm(arg_a: c2v) c2v {
    ...
    _ = &sq;
    return if (sq != 0) c2Div(a, c2Len(a)) else c2V(@as(f32, @floatFromInt(@as(c_int, 0))), @as(f32, @floatFromInt(@as(c_int, 0))));
}
...
pub inline fn c2Parallel(arg_a: c2v, arg_b: c2v, arg_kTol: f32) c_int {
    ...
    _ = &k;
    b = c2Mulvs(b, k);
    if (((if ((a.x - b.x) < @as(f32, @floatFromInt(@as(c_int, 0)))) -(a.x - b.x) else a.x - b.x) < kTol) and ((if ((a.y - b.y) < @as(f32, @floatFromInt(@as(c_int, 0)))) -(a.y - b.y) else a.y - b.y) < kTol)) return 1;
    return 0;
}
...
pub inline fn c2xIdentity() c2x {
    var x: c2x = undefined;
    _ = &x;
    x.p = c2V(@as(f32, @floatFromInt(@as(c_int, 0))), @as(f32, @floatFromInt(@as(c_int, 0))));
    x.r = c2RotIdentity();
    return x;
}
...
pub inline fn c2BBVerts(arg_out: [*c]c2v, arg_bb: [*c]c2AABB) void {
    ...
    var bb = arg_bb;
    _ = &bb;
    out[@as(c_uint, @intCast(@as(c_int, 0)))] = bb.*.min;
    out[@as(c_uint, @intCast(@as(c_int, 1)))] = c2V(bb.*.max.x, bb.*.min.y);
    out[@as(c_uint, @intCast(@as(c_int, 2)))] = bb.*.max;
    out[@as(c_uint, @intCast(@as(c_int, 3)))] = c2V(bb.*.min.x, bb.*.max.y);
}
...
pub const CUTE_C2_API = "";
pub const C2_INLINE = @compileError("unable to translate macro: undefined identifier `always_inline`");
// lib/cute_c2/cute_c2.h:434:10
...
// /Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX26.2.sdk/usr/include/sys/_symbol_aliasing.h:1007:9
pub const __DARWIN_ALIAS_STARTING_MAC___MAC_26_0 = @compileError("unable to translate C expr: unexpected token ''");
// /Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX26.2.sdk/usr/include/sys/_symbol_aliasing.h:1013:9
pub const __DARWIN_ALIAS_STARTING_MAC___MAC_26_1 = @compileError("unable to translate C expr: unexpected token ''");
// /Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX26.2.sdk/usr/include/sys/_symbol_aliasing.h:1019:9
pub const __DARWIN_ALIAS_STARTING_MAC___MAC_26_2 = @compileError("unable to translate C expr: unexpected token ''");
// /Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX26.2.sdk/usr/include/sys/_symbol_aliasing.h:1025:9
...
// /Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX26.2.sdk/usr/include/secure/_strings.h:65:9
pub const __bzero_chk_func = @compileError("unable to translate C expr: expected ')' instead got '...'");
// /Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX26.2.sdk/usr/include/secure/_strings.h:70:9
...
// /Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX26.2.sdk/usr/include/secure/_string.h:97:9
pub const __is_gcc = @compileError("unable to translate macro: undefined identifier `gcc_major`");
// /Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX26.2.sdk/usr/include/secure/_string.h:113:9
...
// /Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX26.2.sdk/usr/include/secure/_string.h:126:9
pub const __memmove_chk_func = @compileError("unable to translate C expr: expected ')' instead got '...'");
// /Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX26.2.sdk/usr/include/secure/_string.h:131:9
pub const __memset_chk_func = @compileError("unable to translate C expr: expected ')' instead got '...'");
// /Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX26.2.sdk/usr/include/secure/_string.h:136:9
pub const __stpncpy_chk_func = @compileError("unable to translate C expr: expected ')' instead got '...'");
// /Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX26.2.sdk/usr/include/secure/_string.h:141:9
pub const __strncpy_chk_func = @compileError("unable to translate C expr: expected ')' instead got '...'");
// /Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX26.2.sdk/usr/include/secure/_string.h:146:9
pub const __strlcpy_chk_func = @compileError("unable to translate C expr: expected ')' instead got '...'");
// /Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX26.2.sdk/usr/include/secure/_string.h:153:9
pub const __strlcat_chk_func = @compileError("unable to translate C expr: expected ')' instead got '...'");
// /Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX26.2.sdk/usr/include/secure/_string.h:158:9
pub const __memccpy_chk_func = @compileError("unable to translate C expr: expected ')' instead got '...'");
// /Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX26.2.sdk/usr/include/secure/_string.h:163:9
pub const __strcpy_chk_func = @compileError("unable to translate C expr: expected ')' instead got '...'");
// /Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX26.2.sdk/usr/include/secure/_string.h:171:9
pub const __stpcpy_chk_func = @compileError("unable to translate C expr: expected ')' instead got '...'");
// /Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX26.2.sdk/usr/include/secure/_string.h:176:9
pub const __strcat_chk_func = @compileError("unable to translate C expr: expected ')' instead got '...'");
// /Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX26.2.sdk/usr/include/secure/_string.h:181:9
pub const __strncat_chk_func = @compileError("unable to translate C expr: expected ')' instead got '...'");
// /Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX26.2.sdk/usr/include/secure/_string.h:187:9
pub const __MATH_H__ = "";
pub const __MATH__ = "";
pub const HUGE_VAL = @compileError("unable to translate macro: undefined identifier `__builtin_huge_val`");
// /Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX26.2.sdk/usr/include/math.h:63:15
pub const HUGE_VALF = __builtin_huge_valf();
pub const HUGE_VALL = @compileError("unable to translate macro: undefined identifier `__builtin_huge_vall`");
// /Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX26.2.sdk/usr/include/math.h:65:15
...
// /Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX26.2.sdk/usr/include/math.h:139:9
pub const isnormal = @compileError("unable to translate: TODO long double");
// /Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX26.2.sdk/usr/include/math.h:164:9
pub const isfinite = @compileError("unable to translate: TODO long double");
// /Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX26.2.sdk/usr/include/math.h:169:9
pub const isinf = @compileError("unable to translate: TODO long double");
// /Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX26.2.sdk/usr/include/math.h:174:9
pub const isnan = @compileError("unable to translate: TODO long double");
// /Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX26.2.sdk/usr/include/math.h:179:9
pub const signbit = @compileError("unable to translate: TODO long double");
// /Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX26.2.sdk/usr/include/math.h:184:9
pub const isgreater = @compileError("unable to translate macro: undefined identifier `__builtin_isgreater`");
// /Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX26.2.sdk/usr/include/math.h:574:9
pub const isgreaterequal = @compileError("unable to translate macro: undefined identifier `__builtin_isgreaterequal`");
// /Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX26.2.sdk/usr/include/math.h:575:9
pub const isless = @compileError("unable to translate macro: undefined identifier `__builtin_isless`");
// /Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX26.2.sdk/usr/include/math.h:576:9
pub const islessequal = @compileError("unable to translate macro: undefined identifier `__builtin_islessequal`");
// /Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX26.2.sdk/usr/include/math.h:577:9
pub const islessgreater = @compileError("unable to translate macro: undefined identifier `__builtin_islessgreater`");
// /Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX26.2.sdk/usr/include/math.h:578:9
pub const isunordered = @compileError("unable to translate macro: undefined identifier `__builtin_isunordered`");
// /Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX26.2.sdk/usr/include/math.h:579:9
...
pub inline fn c2Sin(radians: anytype) @TypeOf(sinf(radians)) {
    _ = &radians;
    return sinf(radians);
}
pub inline fn c2Cos(radians: anytype) @TypeOf(cosf(radians)) {
    _ = &radians;
    return cosf(radians);
}
pub inline fn c2Sqrt(a: anytype) @TypeOf(sqrtf(a)) {
    _ = &a;
    return sqrtf(a);
}
